 ...
 *
 * Modified by Sébastien Barré - sbarre@info.ucl.ac.be
 * date : May 2007
 *
 */
...
/*writes a string representation of addr in str, returns str.
 * str MUST be of size INET6_ADDRSTRLEN*/
const char* addrtostr(const struct in6_addr* addr);

/*from the linux kernel header : net/ipv6.h*/
...
/*From the DoCoMo SEND implementation*/
